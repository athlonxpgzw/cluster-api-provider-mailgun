...
import (
	...
	infrastructurev1alpha1 "github.com/athlonxpgzw/cluster-api-provider-mailgun/api/v1alpha1"
	"github.com/athlonxpgzw/cluster-api-provider-mailgun/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0450eba4.cluster.x-k8s.io",
